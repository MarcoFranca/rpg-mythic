    ...
    return (
        <main className="relative min-h-[100dvh] bg-black text-white">
            ...
            <div className="pointer-events-none absolute inset-0 z-0">
                <Particles/>
                <div
                    className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(124,58,237,0.15),transparent_60%),radial-gradient(ellipse_at_bottom,rgba(56,189,248,0.15),transparent_60%)]"/>
          ...
          <span
              className="inline-grid h-8 w-8 place-items-center rounded-md bg-gradient-to-br from-violet-500/70 to-cyan-400/70 shadow-lg shadow-cyan-500/10">
                ...
                <nav className="hidden md:flex items-center gap-2">
                    <Link href="/login">
                        <Button variant="ghost"
                                className="text-white/85 hover:text-white focus-visible:ring-2 focus-visible:ring-violet-400">
                            Entrar
                        </Button>
                    </Link>
                    <Link href="/app">
                        <Button
                            className="bg-violet-600 hover:bg-violet-500 text-white focus-visible:ring-2 focus-visible:ring-cyan-400">
                            Entrar no Portal
                        </Button>
                    </Link>
                </nav>
            ...
            <HeroDragon>
                <section className="text-center">
                    <div
                        className="mb-3 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[.03] px-3 py-1 text-xs text-white/70">
                    ...
                    <h1 className="mx-auto max-w-3xl text-balance text-4xl font-bold tracking-tight md:text-6xl">
                        Entre no <span
                        className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 via-fuchsia-400 to-cyan-300">Portal Mítico</span>
                    </h1>
                    ...
                    <div className="mt-6 flex items-center justify-center gap-3">
                        <Link href="/app"><Button size="lg"
                                                  className="bg-violet-600 text-white hover:bg-violet-500 hover:scale-102 hover:shadow-[0_0_20px_rgba(139,92,246,0.6)] transition-transform duration-800">Entrar
                            no Sistema</Button></Link>
                        <Link href="/login"><Button size="lg" variant="outline"
                                                    className="border-white/30 text-white hover:border-cyan-400 hover:scale-102 transition-transform duration-800">Criar/Entrar</Button></Link>
                    </div>
                    ...
                    >
                        <div
                            className="absolute inset-0 z-0 rounded-3xl border border-white/10 bg-white/[.02] backdrop-blur-sm"/>
