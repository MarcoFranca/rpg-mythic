...
export default function PlayerBookLayout({ sidebar, children, title, subtitle }: PlayerBookLayoutProps) {
    return (
        <section className="relative overflow-hidden grid h-[calc(100dvh-64px)] grid-cols-1 md:grid-cols-[320px_1fr] bg-black text-white">
            ...
            <main className="relative w-ful overflow-y-auto">
                {/* “folhas” do livro: */}
